...
public class Category {
    ...
    public Category(Long id, Integer version, String name, boolean active, Instant createdDate, Instant updatedDate) {
        this.id = id;
    ...
    public void validate() {
        if (name == null || name.isBlank()) throw new DomainException("Category name cannot be empty");
    }
