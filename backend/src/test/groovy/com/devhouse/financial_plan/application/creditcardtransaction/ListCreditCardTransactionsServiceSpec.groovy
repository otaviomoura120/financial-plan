...
class ListCreditCardTransactionsServiceSpec extends Specification {
    ...
    def "execute returns the credit card transactions matching the filter"() {
        ...
        creditCardTransactionRepository.findByFilter(1L, 10L, null, null, LocalDate.of(2026, 3, 1), LocalDate.of(2026, 3, 31), null) >> [transaction]
    ...
    def "execute returns an empty list when there are no matches"() {
        given:
        creditCardTransactionRepository.findByFilter(99L, null, null, null, null, null, null) >> []
    ...
    def "execute filters by referenceMonth when provided"() {
        ...
        then:
        1 * creditCardTransactionRepository.findByFilter(1L, 10L, null, null, null, null, referenceMonth) >> [transaction]
        responses.size() == 1
